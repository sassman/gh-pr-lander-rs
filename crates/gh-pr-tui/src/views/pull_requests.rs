...
use crate::App;
use crate::state::{AddRepoField, AddRepoForm, LoadingState, PrNumber};
use crate::theme::Theme;

/// Render the repository tabs and PR table
pub fn render_pr_table_and_tabs(f: &mut Frame, table_area: Rect, tabs_area: Rect, app: &mut App) {
